        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_Depertments_DepertmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Depertments_DepertmentId",
                        column: x => x.DepertmentId,
                        principalTable: "Depertments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectWorkLogs_Users_ApprovedByUserId",
                        column: x => x.ApprovedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectWorkLogs_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_DepertmentId",
                table: "Projects",
                column: "DepertmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectWorkLogs_ApprovedByUserId",
                table: "ProjectWorkLogs",
                column: "ApprovedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectWorkLogs_ProjectId",
                table: "ProjectWorkLogs",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectWorkLogs_UserId",
                table: "ProjectWorkLogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Users_DepertmentId",
                table: "Users",
                column: "DepertmentId");
        }
